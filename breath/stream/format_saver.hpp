...
//      --------------------------
//
//      For sake of simplicity we only support char-based streams.
//      Also, we chose to have a single class to save all the relevant
//      format information, rather than one class for each attribute
//      (as, for instance, some Boost facilities do) for
//      two reasons:
//
