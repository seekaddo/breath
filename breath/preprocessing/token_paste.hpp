...
/*
        ...
        does, it was deemed that the name
        BREATH_CONCATENATE_TOKEN was a tad too long, especially
        considering that this macro is often invoked within other
        macro invocations. "Token pasting" is a well-established
        expression within the C and C++ communities. (A similar
        comment applies, obviously, to the _DELAYED variant)
*/
